      ...
      <div { ...useBlockProps() }>
        <div className='inner-header'>
          ...
          <div className='right-section'>
            <div className='header-search'><svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M16.8301 9.83984V10.7398C20.1901 10.7398 22.9201 13.4698 22.9201 16.8298H23.8201C23.8201 12.9598 20.7001 9.83984 16.8301 9.83984Z" fill="var(--action-main-svg, rgb(255, 255, 255))" fill-opacity="0.64"/>
            </svg></div>
            ...
            {cartLink &&
              (<div className='header-cart-link'><a href={cartLink}>
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
